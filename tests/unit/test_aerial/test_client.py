...
def test_ledger_client_timeouts():
    ...
    assert client._query_interval_secs == DEFAULT_QUERY_INTERVAL_SECS
    assert client._query_timeout_secs == DEFAULT_QUERY_TIMEOUT_SECS
    ...
    assert client._query_interval_secs == interval
    assert client._query_timeout_secs == timeout
